...
const AddItem = () => {
  ...
  //     </div>
  //     <div className="max-w-lg w-full bg-white shadow-x1 rounded-2xl p-8 border border-orange-100">
  ...
  bg-linear-to-br bg-white">
      ...
      <div
        ...
        onClick={() => navigate("/")}
      >
        <IoArrowBack size={32} className="text-orange-500 hover:scale-110 transition" />
      </div>
    ...
    rounded-2xl shadow-xl border border-orange-100 p-6 md:p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Fill details to add new product
          </p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              type="file"
              accept="image/*"
              className="w-full mt-1 px-4 py-2 rounded-xl border border-gray-200
            bg-white/70"
              onChange={handleImage}
            />
          ...
          >
            {loading ? <ClipLoader size={20} color="white" /> : "Save Food"}
          </button>
