    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {shop && (
        <div className="relative w-full h-64 md-h-80 md-w-90 lg:h-96">
          ...
          >
            <FaStore className="text-white text-4xl mb-3 drop-shadow-md hover:text-[#ff4d2d]" />
            <h1 className="text-3xl md:text-5xl font-extrabold text-white drop-shadow-lg hover:text-[#ff4d2d]">
              {shop.name}
            </h1>
