...
//         {/* BOTTOM */}
//         <p className="mt-10 text-xs text-gray-500 leading-relaxed text-center sm:text-left">
//           © 2026 Fletto Pvt. Ltd. All rights reserved. <br />
//           Fletto is a food delivery platform connecting customers, restaurants,
